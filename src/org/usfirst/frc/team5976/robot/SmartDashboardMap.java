...
public class SmartDashboardMap {
    ...
    public static final SmartValue ALLOWABLE_ERROR = makeValue("Allowable Error", 200);
    ...
    // Lift Encoders
    public static final SmartValue LIFT_kP = makeValue("P-Value Lift", 0.4);
    ...
    public static final SmartValue LIFT_PEAK_VOLTAGE = makeValue("Lift Peak Voltage", 1);
    ...
    //Grabber Values
    public static final SmartValue GRABBER_POSITION_1 = makeValue("Grab Position 1", 0.6);
    public static final SmartValue GRABBER_POSITION_2 = makeValue("Grab Position 2", 0.5);
    public static final SmartValue GRABBER_PARTIAL_OPEN = makeValue("Grab Partial Position", 0.4);
