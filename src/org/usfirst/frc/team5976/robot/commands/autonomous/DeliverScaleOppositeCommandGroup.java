...
public class DeliverScaleOppositeCommandGroup extends CommandGroup{
    ...
    class MainCommandGroup extends CommandGroup {
        public MainCommandGroup() {
            ...
            addSequential(new EncoderDriveStraightCommand(driveTrain, 215, 6.5)); //WAS ORIGINALLY 209.73
            ...
            addSequential(new EncoderDriveStraightCommand(driveTrain, 195, 6.5)); //WAS ORIGINALLY 190
            addSequential(new EncoderTurnCommand(driveTrain, 90 * position, 2.5));
            addSequential(new WaitForLiftRaised());
            //WAS ORIGINALLY 54
            addSequential(new EncoderDriveStraightCommand(driveTrain, 48, 3)); //TODO: Check timeout value
